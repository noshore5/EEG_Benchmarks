...
USAGE
-----
    python -m BCI.moabb_pipelines.debug_sparse_evidence_gnn \\
        --trial 0 --out BCI/debug_plots/surrogate_pipeline/

(or `python BCI/moabb_pipelines/debug_sparse_evidence_gnn.py ...`
...
try:
    from BCI.moabb_pipelines.common import make_gaussian_weight2d
    from BCI.moabb_pipelines.sparse_evidence_gnn_classifier import (
        SparseEvidenceGNNClassifier,
    )
    from BCI.moabb_pipelines.xwt_phase_gnn_classifier import (
        _BaseCWTGNNClassifier,
    )
    from BCI.run_pipelines import EVOLVING_GRAPH_PARAMS
...
def main():
    ...
    parser.add_argument(
        "--out", type=str, default="BCI/debug_plots/surrogate_pipeline",
