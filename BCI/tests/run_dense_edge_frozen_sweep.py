...
(2026-08-10). Three parts, selected via the CLI subcommand:
    ...
    python BCI/tests/run_dense_edge_frozen_sweep.py cache
    python BCI/tests/run_dense_edge_frozen_sweep.py sweep
    python BCI/tests/run_dense_edge_frozen_sweep.py validate --variant <name>
...
from BCI.moabb_pipelines.common import set_seed, upper_pair_indices
from BCI.moabb_pipelines.dense_conv_feature_cache import (
...
from BCI.tests.run_dense_edge_flat_control import (
