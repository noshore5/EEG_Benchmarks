...
USAGE
-----
    python BCI/tests/run_sparse_event_stats_baseline.py
"""
...
from BCI.moabb_pipelines.common import upper_pair_indices
...
CANONICAL_EVENT_KWARGS: dict[str, object] = dict(
    ...
    feature_ablation="zero_channel_embed",  # irrelevant -- forward() is never called; "none" is no longer a valid value (2026-08-17)
