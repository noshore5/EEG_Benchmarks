...
_Data mirroring, RunPod pod images, and the fused `mamba-ssm` CUDA kernel image. Split out of the top-level README on 2026-09-06; content otherwise unchanged._
