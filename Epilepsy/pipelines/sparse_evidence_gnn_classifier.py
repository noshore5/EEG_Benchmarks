...
try:
    ...
    from Epilepsy.pipelines.xwt_phase_gnn_classifier import (
    ...
    from pipelines.xwt_phase_gnn_classifier import _BaseCWTGNNClassifier
...
class SparseEvidenceGNNClassifier(_BaseCWTGNNClassifier):
    ...
    def _precompute_dense_edge_inputs(self, raw_x, w_real, w_imag, freqs, raw_x_native=None):
        ...
        return torch.cat(all_dense, dim=0)
