...
USAGE
-----
    python coheriqs_contributions/tests/run_time_averaged_coherence_graph.py smoke
    python coheriqs_contributions/tests/run_time_averaged_coherence_graph.py run [subject ...]
"""
