...
USAGE
-----
    python coheriqs_contributions/tests/run_dense_edge_flat_control.py smoke
    python coheriqs_contributions/tests/run_dense_edge_flat_control.py run
"""
...
from coheriqs_contributions.moabb_pipelines.common import set_seed
...
CANONICAL_HELPER_KWARGS: dict[str, object] = dict(
    ...
    feature_ablation="none",  # irrelevant -- forward() on the helper is never called
