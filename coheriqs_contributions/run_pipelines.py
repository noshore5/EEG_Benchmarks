"""Single entry point for every active pipeline in this repo.
    ...
    python coheriqs_contributions/run_pipelines.py --pipeline sparse_evidence --subjects 1 2 3 4
    python coheriqs_contributions/run_pipelines.py --pipeline eegnet wct_evidence_gnn --subjects 1
