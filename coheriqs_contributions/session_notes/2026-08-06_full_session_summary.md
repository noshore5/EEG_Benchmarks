...
`coheriqs_contributions/run_logs/` docs folder (populated only on explicit
...
- Confirmed epochs 50→100 was a **real gain**: 0.799→0.828 on subject 1
  ...
  `coheriqs_contributions/run_logs/2026-08-06_canonical-sparse_epochs100_bs8.md`.
...
3. **8-seed × 2-batch-size follow-up sweep** (seeds 42-49 × batch_size {8,10},
   ...
   `coheriqs_contributions/run_logs/2026-08-06_sparse-evidence-gnn_bs8-vs-bs10_8seed-sweep.md`.
