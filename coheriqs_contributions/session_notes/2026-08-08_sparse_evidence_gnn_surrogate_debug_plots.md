...
Added
[coheriqs_contributions/moabb_pipelines/debug_sparse_evidence_gnn.py](../moabb_pipelines/debug_sparse_evidence_gnn.py),
...
- `debug_sparse_evidence_gnn.py` is now a committed, reusable tool --
  `python coheriqs_contributions/moabb_pipelines/debug_sparse_evidence_gnn.py
